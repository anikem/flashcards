...
function beginActivity(){
 ...
 $("#cardArea").on("click",function(){
  if(cardState!=1){
   cardState=1;
   //togglePosition();
   $("#card1").animate({top: "-=600"}, 150, function() {cardState=0;togglePosition();});
   $("#card2").animate({top: "-=600"}, 150, function() {togglePosition2();});
  }//if
 });//click function
...
function togglePosition(){
 if($("#card1").position().top==-600){$("#card1").css("top","600px");};
}//toggle

function togglePosition2(){
 if($("#card2").position().top==-600){$("#card2").css("top","600px");};
}//toggle2
